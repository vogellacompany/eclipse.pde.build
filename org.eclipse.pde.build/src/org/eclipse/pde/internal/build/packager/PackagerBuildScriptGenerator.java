...
public class PackagerBuildScriptGenerator extends FeatureBuildScriptGenerator {
	...
	public void run() throws CoreException {
		...
		configAssembler.initialize(workingDirectory, DEFAULT_ASSEMBLE_FILENAME, "", config, assemblageInformation.getPlugins(config), assemblageInformation.getFeatures(config), true, "zip"); //$NON-NLS-1$ //Here the last arg is true because we do not have the root info while packaging
